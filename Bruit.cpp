...
//=========================================================
    ...
    //=============================================================================================
    void Bruit::genere_bruit_8bits(uint32_t largeur, uint32_t hauteur, float intensite, uint8_t* tempon)

        {
            ...
            for (y=0;y<hauteur;y++)
            {
                for(x=0;x<largeur;x++)
                {
                    tempon[x+y*largeur]=uint8_t(intensite*float(rand())/32768.*255.);
                }
            }
        }
